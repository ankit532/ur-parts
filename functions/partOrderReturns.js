            ...
            if (job.parts !== undefined) {
                ...
                parts.forEach(part => {
                    if (part.partStatus !== undefined) {
                        if (part.partStatus.trim().toLowerCase() === "retured-vendor" || part.partStatus.trim().toLowerCase() === "returned-office") {
                            ...
                            row["partStatus"] = (part.partStatus !== undefined) ? part.partStatus : "undefined";
                            row["orderDateTime"] = (job.createdAt !== undefined) ? job.createdAt : "undefined";
                            row["orderReturnDateTime"] = (job.updatedAt !== undefined) ? job.updatedAt : "undefined";
                            row["orderedBy"] = (job.requesterName !== undefined) ? job.requesterName : "undefined";
                            ...
                            row["partOurTotalPrice"] = (part.ourPrice !== undefined) ? part.ourPrice : "undefined";
                            row["paymentStatus"] = (job.paymentMethod !== undefined && job.paymentMethod == "cash") ? "Paid" : "Pending";
                            result.push(row);
                        }
                    }
                });
